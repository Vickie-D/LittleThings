            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(246, 226, 179, 90),
                  border: isSelected ? Border.all(width: 5.0, color: Color.fromRGBO(242, 183, 41, 100)) : Border.all(width: 4.5, color: Color.fromRGBO(174, 103, 6, 90)),
